...
import 'package:glycemic_index/models/chat_message.dart';
import 'package:glycemic_index/provider/ask_provider.dart';
import 'package:glycemic_index/provider/revenuecat.dart';
import 'package:glycemic_index/screens/ai/components/message.dart';
import 'package:glycemic_index/screens/ai/modelview/ai_modelview.dart';
import 'package:glycemic_index/screens/ai/components/ai_dietitian_history.dart';
import 'package:glycemic_index/screens/ai/components/custom_icon_button.dart';
import 'package:glycemic_index/screens/ai/components/custom_loading.dart';
import 'package:glycemic_index/screens/ai/components/hi_ai.dart';
import 'package:glycemic_index/screens/calendar/components/pro_leading.dart';
              ...
              builder: (context, ref, child) {
                ...
                return Column(
                  children: [
                    if (chatRef.isTyping) ...[
                      const SizedBox(
                        height: AppConst.kDefaultEdgeInsets,
                      ),
            ...
            return providerone.Consumer<RevenueCatProvider>(
              builder: (context, revenueCatProvider, child) {
                return Message(
                  ...
                  onTap: () async {
                    final value =
                        await SecureStorage().readSecureData('aiChat');
